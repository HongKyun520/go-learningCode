...
func (m *MockService) Send(ctx context.Context, tql string, args []string, phone ...string) error {
	m.ctrl.T.Helper()
	varargs := []any{ctx, tql, args}
	for _, a := range phone {
...
func (mr *MockServiceMockRecorder) Send(ctx, tql, args any, phone ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, tql, args}, phone...)
